...
def load_data(city, month, day):
    ...
    # DOUBLE CHECK --> filter by month if applicable
    if month != 'all':
    ...
    # DOUBLE CHECK --> filter by day of week if applicable
    if day != 'all':
...
def time_stats(df):
    ...
    print("The most common day of the week for travel is ", df['Day of Week'].mode()[0], "\n")
...
def trip_duration_stats(df):
    ...
    print("The average time in minutes for a trip is ", df['Trip Duration'].mean() / 60, "\n")
